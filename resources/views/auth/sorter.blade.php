...
<body>
    ...
    <div style="max-width: 28rem; margin: -2rem auto 0 auto; padding: 4rem; background-color: #fff; border-radius: 1.5rem; border: 4px solid #D1CEC5; line-height:auto;">
        <form style="max-width: 20rem; margin: 0 auto;" method="POST" action="{{ route('sorter') }}" novalidate>
            @csrf
            <div style="margin-bottom: 2.25rem; display: flex;">
                <div style="margin-right: 2rem; flex: 8;;flex: 1; margin-left: -5rem;">
                    ...
                    <input type="name" id="name" style="background-color: #F3F4F6; ;border: 1px solid #CBD5E0; font-size: 0.875rem; border-radius: 0.375rem; display: block; width: 100%; padding: 0.625rem;" required />
                    @error('name')
                ...
                <div style="flex: 0.5;margin-right: -5rem">
                    ...
                    <input type="age" id="age" style="background-color: #F3F4F6; border: 1px solid #CBD5E0; font-size: 0.875rem; border-radius: 0.375rem; display: block; width: 100%; padding: 0.625rem;" required />
                    @error('age')
                    <p style="background-color: #f56558; color: #fff; margin-top: 0.5rem; border-radius: 0.375rem; font-size: 1rem; text-align: center; padding: 0.25rem;">{{$message}}</p>
                    @enderror
                </div>
            ...
            <div style="margin-bottom: 1.25rem;flex: 1; margin-left: -5rem;margin-right:-5rem;">
                ...
                <input type="mail" id="mail" style="background-color: #F3F4F6; border: 1px solid #CBD5E0; font-size: 0.875rem; border-radius: 0.375rem; display: block; width: 100%; padding: 0.625rem;" required />
                @error('mail')
                <p style="background-color: #f56558; color: #fff; margin-top: 0.5rem; border-radius: 0.375rem; font-size: 1rem; text-align: center; padding: 0.25rem;">{{$message}}</p>
                @enderror
            </div>
