...
<div class="container">
    ...
    <div style="max-width: 28rem; margin: 0 auto; padding: 1.5rem; background-color: #fff; border-radius: 1.5rem; border: 4px solid #D1CEC5;">
        <form style="max-width: 20rem; margin: 0 auto;" method="POST" action="{{ route('logg') }}" novalidate>
        <div style="margin-right: 1.25rem; flex: 2;">
                    <label for="uname" style="margin-bottom: 0.5rem; font-size: 0.875rem; font-weight: 500;">Correo Electrónico:</label>
                    <input type="text" id="uname" style="background-color: #F3F4F6; border: 1px solid #CBD5E0; font-size: 0.875rem; border-radius: 0.375rem; display: block; width: 100%; padding: 0.625rem;" required />
                    @error('uname')
                ...
                <div style="margin-right: 1.25rem; flex: 2;">
                    <label for="psw" style="margin-bottom: 10px 0.5rem; font-size: 0.875rem; font-weight: 500;">Contraseña:</label>
                    <input type="password" id="psw" style="background-color: #F3F4F6; border: 1px solid #CBD5E0; font-size: 0.875rem; border-radius: 0.375rem; display: block; width: 100%; padding: 0.625rem;" required />
                    @error('psw')
                    <p style="background-color: #f56558; color: #fff; margin-top: 0.5rem; border-radius: 0.375rem; font-size: 1rem; text-align: center; padding: 0.25rem;">{{$message}}</p>
                    @enderror
                </div>
